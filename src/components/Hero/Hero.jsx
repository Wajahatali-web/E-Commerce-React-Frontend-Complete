    ...
    return (
        <div className="h-full bg-[linear-gradient(180deg,_#fde1ff,_#e1ffea22_60%)] flex flex-col md:flex-row">
            ...
            <div className="flex-1 flex flex-col justify-center gap-[20px] px-6 md:pl-[180px] leading-[1.1] text-center md:text-left">
                ...
                {/* Button */}
                <div className="flex justify-center md:justify-start items-center gap-[15px] w-[250px] md:w-[310px] h-[60px] md:h-[70px] rounded-[75px] mt-[30px] bg-[#ff4141] text-white text-[18px] md:text-[22px] font-medium mx-auto md:mx-0">
